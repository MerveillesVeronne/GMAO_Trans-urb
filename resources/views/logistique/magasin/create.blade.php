...
@section('title', "GMAO Trans'urb - Ajouter un Article")
...
@section('content')
    <header class="bg-green-900 shadow-xl mb-6">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex items-center gap-4">
            <div class="h-10 w-10 bg-white rounded-full flex items-center justify-center shadow">
                <i class="fas fa-plus text-green-800 text-xl"></i>
            </div>
            <span class="text-2xl font-bold tracking-wide text-white">Trans'urb GMAO - Ajouter un Article</span>
        </div>
    </header>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-white rounded-xl shadow-lg overflow-hidden">
            ...
            <form action="{{ route('logistique.magasin.store') }}" method="POST" class="p-4">
                @csrf
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <select id="categorie" name="categorie" required 
                            ...
                            <option value="Pièces mécaniques" {{ old('categorie') == 'Pièces mécaniques' ? 'selected' : '' }}>Pièces mécaniques</option>
                            <option value="Pièces électriques" {{ old('categorie') == 'Pièces électriques' ? 'selected' : '' }}>Pièces électriques</option>
                            <option value="Huiles et lubrifiants" {{ old('categorie') == 'Huiles et lubrifiants' ? 'selected' : '' }}>Huiles et lubrifiants</option>
                            <option value="Filtres" {{ old('categorie') == 'Filtres' ? 'selected' : '' }}>Filtres</option>
                            <option value="Outillage" {{ old('categorie') == 'Outillage' ? 'selected' : '' }}>Outillage</option>
