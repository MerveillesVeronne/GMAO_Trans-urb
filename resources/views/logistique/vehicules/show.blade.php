...
<head>
    ...
    <title>GMAO Trans'urb - Détails Véhicule (Logistique)</title>
...
<body>
    <div class="header-bg">
        ...
        <div class="welcome-banner">
            <div>
                <div class="greeting">Détails Véhicule - Logistique</div>
                <div class="subtitle">Consultation des informations du véhicule {{ $vehicule->numero }}</div>
            </div>
        ...
        <div class="content-card">
            <div class="flex justify-between items-center mb-6">
                <h2 class="text-2xl font-bold text-gray-900">
                    <i class="fas fa-bus mr-2 text-purple-600"></i>Détails du Véhicule {{ $vehicule->numero }}
                </h2>
                <div class="flex gap-3">
                    <a href="{{ route('logistique.vehicules.index') }}" class="btn-secondary">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
                <div class="bg-purple-50 rounded-lg p-6">
                    ...
                    <div class="space-y-3">
                        <div class="flex justify-between">
                            ...
                            <span class="font-semibold text-purple-900">{{ $vehicule->numero }}</span>
                        </div>
                        <div class="flex justify-between">
                            <span class="text-gray-600">Immatriculation:</span>
                            <span class="font-semibold text-purple-900">{{ $vehicule->immatriculation }}</span>
                        </div>
                        <div class="flex justify-between">
                            <span class="text-gray-600">Type:</span>
                            <span class="font-semibold text-purple-900">{{ $vehicule->type_vehicule ?? 'Non spécifié' }}</span>
                        </div>
                        <div class="flex justify-between">
                            <span class="text-gray-600">Marque:</span>
                            <span class="font-semibold text-purple-900">{{ $vehicule->marque }}</span>
                        </div>
                        <div class="flex justify-between">
                            <span class="text-gray-600">Modèle:</span>
                            <span class="font-semibold text-purple-900">{{ $vehicule->modele }}</span>
                        </div>
                        <div class="flex justify-between">
                            <span class="text-gray-600">Année:</span>
                            <span class="font-semibold text-purple-900">{{ $vehicule->annee }}</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-green-50 rounded-lg p-6">
                    <h3 class="text-lg font-semibold text-green-900 mb-4">
                        <i class="fas fa-cogs mr-2"></i>Statut et Affectation
                    </h3>
                    <div class="space-y-3">
                        <div class="flex justify-between">
                        ...
                        <div class="flex justify-between">
                            <span class="text-gray-600">Affectation:</span>
                            <span class="font-semibold text-green-900">{{ $vehicule->affectation }}</span>
                        </div>
                        <div class="flex justify-between">
                            <span class="text-gray-600">Ligne:</span>
                            <span class="font-semibold text-green-900">{{ $vehicule->ligne ?? 'Non assigné' }}</span>
                        </div>
                        <div class="flex justify-between">
                        ...
                        <div class="flex justify-between">
                            ...
                            <span class="font-semibold text-green-900">{{ $vehicule->updated_at->format('d/m/Y H:i') }}</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-blue-50 border border-blue-200 rounded-lg p-4">
                <div class="flex items-center">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-blue-700">Vous consultez les informations du véhicule en mode lecture seule. Les modifications doivent être effectuées depuis le module Maintenance.</p>
                    </div>
                </div>
            </div>
        </div>
