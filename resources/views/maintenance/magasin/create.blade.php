        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
            <div class="flex items-center justify-between">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        <h1 class="text-2xl font-bold tracking-wide text-white">Ajouter un article</h1>
                        <p class="text-green-100">Nouvel article pour le magasin</p>
                    </div>
                </div>
        ...
        <div class="bg-white rounded-lg shadow-lg overflow-hidden">
            <div class="px-6 py-4 bg-gradient-to-r from-green-600 to-green-700">
                <h2 class="text-xl font-semibold text-white">
                    <i class="fas fa-plus mr-2"></i>Informations de l'article
                </h2>
            </div>
            
            <form id="pieceForm" action="{{ route('maintenance.magasin.store') }}" method="POST" class="p-6 space-y-6">
                @csrf
        ...
        .then(data => {
            if (data.success) {
                ...
                if (data.errors) {
                    ...
                    showErrorModal('Erreur', data.message || 'Erreur lors de l\'ajout de l\'article');
                }
            }
        })
        .catch(error => {
            console.error('Erreur:', error);
            showErrorModal('Erreur', 'Erreur lors de l\'ajout de l\'article');
        });
    });
</script>
@endsection
