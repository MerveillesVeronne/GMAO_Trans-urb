...
<head>
    ...
    <title>GMAO Trans'urb - Nouveau Loyer/Charge</title>
...
<body>
    <div class="header-bg">
        ...
        <div class="welcome-banner">
            <div>
                <div class="greeting">Nouveau Loyer/Charge</div>
                <div class="subtitle" style="color: #ffe082;">Ajouter une nouvelle charge fixe</div>
            </div>
    ...
    <div class="main-content">
        <div class="bg-white rounded-lg shadow-md p-6">
            <h2 class="text-2xl font-bold text-gray-800 mb-4">Nouveau Loyer/Charge</h2>
            <p class="text-gray-600">Formulaire pour ajouter un nouveau loyer ou une nouvelle charge fixe.</p>
