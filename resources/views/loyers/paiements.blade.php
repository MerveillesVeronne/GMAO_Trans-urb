...
<head>
    ...
    <title>GMAO Trans'urb - Paiements Loyers & Charges</title>
...
<body>
    <div class="header-bg">
        ...
        <div class="welcome-banner">
            <div>
                <div class="greeting">Paiements Loyers & Charges</div>
                <div class="subtitle" style="color: #ffe082;">Historique et suivi des paiements</div>
            </div>
    ...
    <div class="main-content">
        <div class="bg-white rounded-lg shadow-md p-6">
            <h2 class="text-2xl font-bold text-gray-800 mb-4">Paiements Loyers & Charges</h2>
            <p class="text-gray-600">Historique et suivi des paiements des loyers et charges fixes.</p>
