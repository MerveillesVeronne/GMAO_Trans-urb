...
<head>
    ...
    <title>GMAO Trans'urb - Échéances Loyers & Charges</title>
...
<body>
    <div class="header-bg">
        ...
        <div class="welcome-banner">
            <div>
                <div class="greeting">Échéances Loyers & Charges</div>
                <div class="subtitle" style="color: #ffe082;">Suivi des échéances de paiement</div>
            </div>
    ...
    <div class="main-content">
        <div class="bg-white rounded-lg shadow-md p-6">
            <h2 class="text-2xl font-bold text-gray-800 mb-4">Échéances Loyers & Charges</h2>
            <p class="text-gray-600">Suivi des échéances de paiement des loyers et charges fixes.</p>
