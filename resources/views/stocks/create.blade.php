...
<head>
    ...
    <title>GMAO Trans'urb - Nouveau Produit</title>
...
<body>
    <div class="header-bg">
        ...
        <div class="welcome-banner">
            <div>
                <div class="greeting">Nouveau Produit</div>
                <div class="subtitle">Ajouter un produit au stock</div>
            </div>
            <div class="hidden md:block">
                <i class="fas fa-plus-circle" style="font-size: 2.5rem; color: #ffe082;"></i>
            </div>
        </div>
    </div>
            ...
            <form method="POST" action="{{ route('stocks.store') }}">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="produit" value="{{ old('produit') }}" 
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="quantite_minimale" value="{{ old('quantite_minimale', 0) }}" 
                               class="form-input" min="0" required>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="unite" value="{{ old('unite', 'unité') }}" 
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="cout_unitaire" value="{{ old('cout_unitaire') }}" 
