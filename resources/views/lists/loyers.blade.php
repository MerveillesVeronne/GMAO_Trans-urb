...
<head>
    ...
    <title>GMAO Trans'urb - Loyers & Charges</title>
...
<body>
    <div class="header-bg">
        ...
        <div class="welcome-banner">
            <div>
                <div class="greeting">Loyers & Charges</div>
                <div class="subtitle" style="color: #ffe082;">Gestion des charges fixes et locations</div>
            </div>
    ...
    <div class="main-content">
        <div class="bg-white rounded-lg shadow-md p-6">
            <h2 class="text-2xl font-bold text-gray-800 mb-4">Liste des Loyers & Charges</h2>
            <p class="text-gray-600">Cette page affichera la liste des loyers et charges fixes de l'entreprise.</p>
