...
<head>
    ...
    <title>GMAO Trans'urb - Nouvelle Commande</title>
...
<body>
    <div class="header-bg">
        ...
        <div class="welcome-banner">
            <div>
                <div class="greeting">Nouvelle Commande</div>
                <div class="subtitle">Créer une nouvelle commande fournisseur</div>
            </div>
            ...
            <div class="form-card">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="date" id="date_commande" name="date_commande" value="{{ old('date_commande', date('Y-m-d')) }}" required class="form-input">
                    </div>
                    
                    <div>
                        <label for="date_livraison" class="form-label">Date de livraison prévue</label>
                        <input type="date" id="date_livraison" name="date_livraison" value="{{ old('date_livraison') }}" class="form-input">
                    </div>
                    
                    <div>
                        <label for="commentaires" class="form-label">Commentaires généraux</label>
                        <textarea id="commentaires" name="commentaires" rows="3" class="form-input">{{ old('commentaires') }}</textarea>
                    </div>
                </div>
            </div>
            ...
            <div class="form-card">
                ...
                <div class="total-section">
                    <div class="flex justify-between items-center">
                        ...
                        <span id="total-commande" class="text-2xl font-bold text-green-600">0 FCFA</span>
                    </div>
                </div>
            </div>
